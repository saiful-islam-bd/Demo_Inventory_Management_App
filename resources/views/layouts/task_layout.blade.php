                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="emails">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="pages/email/inbox.html" class="nav-link">Manage Users</a>
                                </li>
                                <li class="nav-item">
    ...
    <script>
        $(function() {
            ...
            $(document).ready(function() {
                ...
                $('#tasksTable').on('click', '.edit', function() {
                    let id = $(this).data('id'); // Fetch the task ID
                    $.ajax({
                        url: "tasks/" + id + "/edit", // Fetch data for the task
                        method: 'GET',
                        success: function(data) {

                            console.log("Edit Task Data:", data); // Debug fetched data
                            $('#editTaskModal').modal('show'); // Show the modal
                            $('#id').val(data.id); // Populate fields
                            $('#e_task_title').val(data.task_title);
                            $('#e_asign_to').val(data.asign_to);
                            $('#e_deadline').val(data.deadline);
                        },
                        error: function(xhr) {
                ...
                // Submit handler for editing task
                $('#editTask').submit(function(e) {
                    e.preventDefault();
                    let id = $('#id').val(); // Get the task ID
                    let url = id ? "tasks/" + id :
                    "{{ route('tasks.store') }}"; // Update or create
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#editTaskModal').modal('hide'); // Hide modal
