        ...
        $(function() {
            ...
            $(document).ready(function() {
                ...
                $('#customerTable').on('click', '.edit', function() {
                    let id = $(this).data('id'); // Fetch the customer ID
                    $.ajax({
                        url: "customers/" + id + "/edit", // Fetch data for the customer
                        method: 'GET',
                        success: function(data) {

                            console.log("Edit customer Data:", data); // Debug fetched data
                            $('#editCustomerModal').modal('show'); // Show the modal
                ...
                // Submit handler for editing customer
                $('#editCustomer').submit(function(e) {
                    e.preventDefault();
                    let id = $('#id').val(); // Get the customer ID
                    let url = id ? "customers/" + id :
                        "{{ route('customers.store') }}"; // Update or create
