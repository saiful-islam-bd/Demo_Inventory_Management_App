        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    {{-- Stuffs --}}
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#stuffs" role="button"
                            aria-expanded="false" aria-controls="stuffs">
                            <i class="link-icon" data-feather="mail"></i>
                            <span class="link-title">Stuffs</span>
                            <i class="link-arrow" data-feather="chevron-down"></i>
                        </a>
                        <div class="collapse" id="stuffs">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="#" class="nav-link">Manage Stuffs</a>
                                </li>
                                {{-- <li class="nav-item">
                                    <a href="pages/email/read.html" class="nav-link">Read</a>
                                </li>
                    ...
                    {{-- Purchases --}}
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#purchases" role="button"
                        ...
                        <div class="collapse" id="purchases">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="" class="nav-link">Manage Purchases</a>
                                </li>
