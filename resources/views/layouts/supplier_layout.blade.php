...
<body>
    <div class="main-wrapper">
        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
                <ul class="nav">
                    ...
                    {{-- Customers --}}
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#customers" role="button"
                    ...
                    {{-- Suppliers --}}
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#suppliers" role="button"
                        ...
                        <div class="collapse" id="suppliers">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('suppliers.index') }}" class="nav-link">Manage Suppliers</a>
                                </li>
                                {{-- <li class="nav-item">
                                    <a href="pages/email/read.html" class="nav-link">Read</a>
                                </li>
        ...
        <div class="page-wrapper">
            ...
            <nav class="navbar" style="margin-left: -240px; width: 100%;">{{-- this style add by me --}}              
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a href="{{ route('logout') }}" class="btn btn-sm btn-dark"
                                style="float: right;margin-right:20px; ">Logout</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <footer
                ...
                <p class="text-muted">Handcrafted With<i class="mb-1 text-primary ms-1 icon-sm"
                    data-feather="heart"></i> by<span style="font-weight: 600; color:red;"> Saiful</span></p>
    ...
    <script>
        $(function() {
            ...
            $('#addSupplier').click(function() {
                ...
                $('#createSupplier')[0].reset();
                $('#id').val('');
            });

            $('#createSupplier').submit(function(e) {
                e.preventDefault();
                $.ajax({
            ...
            $(document).ready(function() {
                ...
                $('#supplierTable').on('click', '.edit', function() {
                    let id = $(this).data('id'); // Fetch the supplier ID
                    $.ajax({
                        url: "suppliers/" + id + "/edit", // Fetch data for the supplier
                        method: 'GET',
                        success: function(data) {

                            console.log("Edit supplier Data:", data); // Debug fetched data
                            $('#editSupplierModal').modal('show'); // Show the modal
                        ...
                        error: function(xhr) {
                            console.error("Error fetching supplier:", xhr
                ...
                // Submit handler for editing supplier
                $('#editSupplier').submit(function(e) {
                    e.preventDefault();
                    let id = $('#id').val(); // Get the supplier ID
                    let url = id ? "suppliers/" + id :
                        "{{ route('suppliers.store') }}"; // Update or create
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            console.error("Error updating supplier:", xhr
                                .responseText); // Debug error
